...
import { SearchCardDebt } from './Cards_details/SearchCardDebt'
interface location{
  loc:string,
}

const  SearchCardSection: React.FC<location> = ({loc}) => {

  const cards = [...SearchCardDebt];

  return (
    <div className='mb-24 mt-20'>
      <TopSection top={loc} bottom={'Latest Listing'}></TopSection>
