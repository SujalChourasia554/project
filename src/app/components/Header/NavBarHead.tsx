...
import LanguageHoverDropdown from './LanguageHoverDropdown';
      ...
      <div className='w-full m-1 px-5 py-1 md:py-0 md:flex md:flex-row md:m-2.5 md:px-24 '>
        <div className='w-full flex flex-row justify-center md:justify-start'>
          <a>
            <div className='flex flex-row justify-center items-center cursor-pointer'>
              ...
              <p className='text-white font-nunito font-medium text-[0.813rem] md:text-sm items-center'>
                info@webmail.com
              </p>
            </div>
          </a>
          <a>
            <div className='flex flex-row justify-center items-center ms-5 lg:ms-10 cursor-pointer'>
              ...
              <p className='text-white text-nowrap font-nunito font-medium text-[0.813rem] md:text-sm'>
                MP Nagar, Zone 2
              </p>
            </div>
          </a>
        ...
        <div className='w-full flex justify-center pt-2 md:py-0 md:flex md:flex-row md:justify-end md:items-center'>
          ...
          <div className='w-full lg:w-auto flex items-center justify-start pl-10 lg:justify-end'>
            <div className='px-1 lg:px-1.5 cursor-pointer'>
