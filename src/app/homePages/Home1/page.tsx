import BuildingAminities from "@/app/components/AminitiesSection/BuildingAminities";
...
export default function RealEstateAgency() {
  return (
    <div>
      {/* Header Section */}
      <header className="flex justify-between items-center px-12 py-6 bg-blue-50">
        <div className="logo">
      ...
      {/* Hero Section */}
      <section className="flex items-center justify-between px-12 py-12 w-full h-full bg-blue-50">
